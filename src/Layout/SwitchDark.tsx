...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-thumb': {
        backgroundColor: theme.palette.mode === 'dark' ? '#003892' : 'rgb(255, 215, 0)',
        width: 32,
        height: 32,
        '&:before': {
            content: "''",
...
function SwitchDark() {
    ...
    return <MaterialUISwitch id="MaterialUISwitchDark" sx={{ m: 1 }} checked={isDark} onChange={handleChange} />;
}
